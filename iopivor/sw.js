const CACHE='iopivor-simple-v9';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon.svg','./app.js','./rules1.js','./rules2.js','./rules3.js','./rules4.js','./rules5.js','./rules6.js','./rules7.js','./rules8.js','./topics-extra.js'];
